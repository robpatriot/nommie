...
async fn integration_problem_details_from_domain_errors() {
    ...
    common::assert_problem_details_structure(resp, 404, "GAME_NOT_FOUND", "game missing").await;
    ...
    common::assert_problem_details_structure(resp, 422, "VALIDATION_ERROR", "bad").await;
    ...
    common::assert_problem_details_structure(resp, 504, "DB_TIMEOUT", "operation timed out").await;
    ...
    common::assert_problem_details_structure(resp, 409, "CONFLICT", "some conflict").await;
}
