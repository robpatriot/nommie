...
export function ScoreSidebar({
  ...
  return (
    <aside
      className={cn(
        'flex h-full flex-col gap-4 rounded-3xl border border-border/60 bg-card/85 p-5 shadow-elevated backdrop-blur',
        className
      )}
    >
      ...
      {round ? (
        <div className="grid grid-cols-2 gap-x-4 gap-y-3 rounded-2xl border border-border/60 bg-card/70 p-3 text-sm text-muted-foreground">
          <PhaseFact
            label={t('facts.round')}
      ...
      <details className="rounded-2xl border border-border/60 bg-card/70" open>
        <summary className="flex cursor-pointer flex-wrap items-center justify-between gap-3 rounded-2xl px-4 py-3 text-sm font-semibold text-foreground transition hover:bg-card">
          ...
          {onShowHistory ? (
            <button
              ...
              className="flex items-center gap-1 rounded-full border border-border/60 bg-card/60 px-3 py-1 text-[11px] font-semibold text-foreground transition hover:border-primary/60 hover:bg-primary/10 hover:text-primary disabled:cursor-not-allowed disabled:opacity-60"
              ...
              return (
                ...
                >
                  <div className="flex min-w-0 flex-1 items-center gap-2">
                    ...
                    {aiProfile ? (
                      <span
                        className="inline-flex items-center rounded-full bg-overlay/20 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-foreground"
