...
export function TrumpSelectPanel({
  ...
  const submitLabel = isPending
    ...
    return (
      <section className="mx-auto flex w-full max-w-4xl flex-col gap-4 rounded-3xl border border-accent/50 bg-accent/15 p-5 shadow-[0_30px_90px_rgba(94,234,212,0.25)]">
        <header className="flex flex-wrap items-center justify-between gap-2 text-accent-foreground">
          <div>
          ...
          <div className="rounded-full border border-accent/60 bg-accent/25 px-3 py-1 text-xs font-semibold">
