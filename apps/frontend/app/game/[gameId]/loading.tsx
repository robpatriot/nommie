  ...
  return (
    <div className="flex min-h-screen flex-col bg-background text-foreground">
      ...
      <main className="flex flex-1 flex-col gap-6 px-4 py-6 sm:px-6 lg:px-10">
        ...
        <section className="flex flex-col gap-4 rounded-xl border border-border bg-card/70 p-4 shadow-elevated">
        ...
        <section className="mx-auto flex w-full max-w-7xl flex-col gap-6">
          <div className="relative mx-auto grid h-full w-full max-w-4xl grid-cols-3 grid-rows-3 gap-4">
            ...
            {[0, 1, 2, 3].map((i) => (
              <div
                key={i}
                className="flex flex-col items-center justify-center gap-2 rounded-xl border border-border bg-card/70 p-4"
              >
                <div className="h-5 w-24 animate-pulse rounded bg-card" />
            ...
            {/* Trick area skeleton */}
            <div className="col-start-2 row-start-2 flex items-center justify-center rounded-xl border border-border bg-card/50 p-8">
              <div className="h-20 w-32 animate-pulse rounded bg-card" />
            </div>
          </div>

          {/* Hand skeleton */}
          <div className="mx-auto flex w-full max-w-4xl flex-col gap-3 rounded-2xl border border-border bg-card/70 p-4">
            ...
            <div className="flex flex-wrap justify-center gap-2">
              {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
                <div
                  key={i}
                  className="h-12 w-16 animate-pulse rounded-xl border border-border bg-card"
                />
              ))}
            </div>
          </div>
        ...
        {/* Sidebar skeleton */}
        <aside className="mx-auto w-full max-w-md rounded-xl border border-border bg-card/70 p-4">
            ...
            <div className="space-y-2">
              {[1, 2, 3, 4].map((i) => (
                ...
                >
                  ...
                  <div className="h-4 w-8 animate-pulse rounded bg-card" />
                </div>
              ))}
            </div>
          </div>
