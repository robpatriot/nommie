          ...
          <div className="rounded-lg border border-border bg-surface-strong shadow-elevated p-6">
            <div className="mb-4 flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="h-9 w-24 animate-pulse rounded bg-surface" />
              </div>
            </div>
            <div className="mb-4 h-10 w-48 animate-pulse rounded bg-surface" />
          </div>
        </div>
            ...
            <div className="rounded-lg border border-border bg-surface p-6">
              <div className="space-y-3">
                {[1, 2, 3].map((i) => (
                  <div
                    key={i}
                    className="flex items-center justify-between gap-4 rounded border border-border bg-surface-strong p-4"
                  >
